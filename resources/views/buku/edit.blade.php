    ...
    <div class="container" style="margin-top: 5%">
        <div class="w-full max-w">
            ...
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="{{ route('buku.update', $buku->id) }}" enctype="multipart/form-data">
                ...
                {{-- CATEGORIES --}}
                <div class="col-span-full mt-6">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="categories">Kategori</label>
                    <div class="mt-2 mb-3" id="categories_wrapper">
                        <div class="mb-2">
                            <input type="text" name="categories[]" class="block w-full mb-2 form-control">
                        </div>
                    </div>
                    <a href="javascript:void(0);" id="tambah" class="btn btn-success mb-4" onclick="addCategoryInput()">+ Tambah</a>
                    <script type="text/javascript">
                        function addCategoryInput() {
                            var div = document.getElementById('categories_wrapper');
                            var input = document.createElement('input');
                            input.type = 'text';
                            input.name = 'categories[]';
                            input.className = 'block w-full mb-2 form-control';
